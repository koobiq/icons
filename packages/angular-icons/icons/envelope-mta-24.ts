...
@Component({
    ...
    template: `<svg:g>
        ...
        />
        <svg:path d="M22.5 15H6.3a1.8 1.8 0 0 0-1.8 1.8V21H3.3a1.8 1.8 0 0 1-1.8-1.8V7.248L12 12.313l10.5-5.065z" />
        <svg:path d="M20.7 3a1.8 1.8 0 0 1 1.8 1.8v.45L12 10.315 1.5 5.25V4.8A1.8 1.8 0 0 1 3.3 3z" />
    </svg:g>`,
