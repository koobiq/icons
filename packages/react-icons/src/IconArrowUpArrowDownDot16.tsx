...
export const IconArrowUpArrowDownDot16 = forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
    ...
    >
        ...
        <path fill="var(--icon-accent-color, currentColor)" d="M15 3a2 2 0 1 1-4 0 2 2 0 0 1 4 0" />
    </svg>
));
