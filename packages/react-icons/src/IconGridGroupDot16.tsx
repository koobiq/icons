...
export const IconGridGroupDot16 = forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
        ...
        {...props}
    >
        <path fill="var(--icon-accent-color, currentColor)" d="M16 2a2 2 0 1 1-4 0 2 2 0 0 1 4 0" />
